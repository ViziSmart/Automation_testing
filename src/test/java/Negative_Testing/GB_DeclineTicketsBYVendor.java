...
public class GB_DeclineTicketsBYVendor {
	
	@Test
	public void DeclineByVendor() throws InterruptedException {
        ...
        //Decline ticket by vendor process...
        ...
        WebElement Decline = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div/div[4]/div/div[2]/button[2]")));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", Decline);
     	Decline.click();

     	WebElement reason = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[2]/div/textarea")));
     	reason.sendKeys("Automation testing");
     	
     	WebElement Deny_btn = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[2]/div/div/button"));
     	Deny_btn.click();
