...
public void add() throws InterruptedException {
    ...
    By tenant_section_single= By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[2]/button[1]");
    By tenant_section_doublt= By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[2]/button[2]");
    
    
    if (isElementPresent(driver, tenant_section_single)) {
        WebElement firstElement = driver.findElement(tenant_section_single);
        ...
        WebElement secondElement = driver.findElement(tenant_section_doublt);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", secondElement);
        secondElement.click();
        System.out.println("Second element clicked.");
    }
    
       
    WebElement add_tenant = driver.findElement(By.xpath("//*[@id=\"tenantstab3\"]"));
    add_tenant.click();
    Reporter.log("Clicked on Add Tenant button", true);
    
    WebElement first_name = driver.findElement(By.xpath("//*[@id=\"tpopup6\"]/input[1]"));
    first_name.sendKeys("Automation Test");
    Reporter.log("Entered First Name: temp", true);
    
    WebElement last_name = driver.findElement(By.xpath("//*[@id=\"tpopup6\"]/input[2]"));
    last_name.sendKeys("tenant");
    Reporter.log("Entered Last Name: tenant", true);
    
    String randomEmail= generateRandomEmail();
    WebElement email = driver.findElement(By.xpath("//*[@id=\"tpopup6\"]/input[3]"));
    email.sendKeys(randomEmail);
    Reporter.log("Entered Email", true);
    
    String randomPhone= generateRandomPhoneNumber();
    WebElement phone_number = driver.findElement(By.xpath("//*[@id=\"tpopup6\"]/input[4]"));
    ...
    WebElement successElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[2]/button[1]")));
    // Assert the presence of the success element
    if (successElement.isDisplayed()) {
        System.out.println("Test Passed: Tenant added to the property successfully.");
    } else {
        System.out.println("Test Failed: failed to add tenant in the property.");
    }
