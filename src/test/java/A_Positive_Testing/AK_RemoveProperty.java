...
public class AK_RemoveProperty {
	...
	public void remove() throws InterruptedException {
	    ...
	    Reporter.log("ChromeDriver initialized", true);
	        ...
	        WebElement removeBtn = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[6]/div/button")));
