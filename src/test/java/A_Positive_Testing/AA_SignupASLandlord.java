...
public class AA_SignupASLandlord {
    ...
    public void Signup_page() throws InterruptedException {
        ...
        WebElement SelectRole = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#root > div > div > div > div:nth-child(1) > div.flex.flex-col.items-center.w-screen.h-14.relative > div > div > ul > li:nth-child(1)")));
