...
public class AB_SignupAsVendor {
    ...
    public void Signup_page() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".loader"))); // Wait for loader to disappear
        ...
        WebElement SelectRole = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#root > div > div > div > div:nth-child(1) > div.flex.flex-col.items-center.w-screen.h-14.relative > div > div > ul > li:nth-child(3)")));
        ...
        WebElement done_btn = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/button"));
        done_btn.click();
        
        Thread.sleep(2000);
        
        WebElement communication= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"notification3\"]/label")));
        communication.click();
        
        WebElement done_button = driver.findElement(By.xpath("//*[@id=\"notification10\"]"));
        done_button.click();
        
        Thread.sleep(2000);
        
        WebElement handyman = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/button[1]")));
        handyman.click();
        
        WebElement zipcode = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div/div[3]/input"));
        zipcode.sendKeys("422605");
        
        WebElement TandC= driver.findElement(By.xpath("//*[@id=\"terms\"]"));
        TandC.click();
        
        WebElement done_btn2 = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div/button"));
        done_btn2.click();
