...
public class AJ_OnbaordVendor {
	...
	public void Onboard() throws InterruptedException {
        ...
        WebElement add_Vendor = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[1]/button/span"));
        add_Vendor.click();
        Reporter.log("Clicked on Add Vendor icon", true);
        
        WebElement OnboardVendors= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div/button"));
        OnboardVendors.click();
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        WebElement FirstName= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[1]/input[1]"));
        FirstName.sendKeys("Automation test");
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        WebElement LastName= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[1]/input[2]"));
        LastName.sendKeys("Vendor");
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        WebElement Company= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[1]/input[3]"));
        Company.sendKeys("64 square llc");
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        String randomEmail= generateRandomEmail();
        WebElement Email= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[1]/input[4]"));
        Email.sendKeys(randomEmail);
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        String randomPhone= generateRandomPhoneNumber();
        WebElement PhoneNumber= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[1]/input[5]"));
        PhoneNumber.sendKeys(randomPhone);
        Reporter.log("Clicked on Add onboard Vendor", true);
        
        WebElement SaveBtn= driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[3]/div/div[5]/div[3]/div[2]/div/div/form/div[2]/button[1]"));
        SaveBtn.click();
        Reporter.log("Clicked on Add onboard Vendor", true);
